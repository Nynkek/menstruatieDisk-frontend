        ...
        <>
            ...
            <BookmarkBox verticalText="gebruik">
                ...
                <ul>
                    ...
                    <li>Spreid je benen. <strong>Schuif de disk voorzichtig in je vagina</strong>, terwijl je de zijkanten samengeknepen
                    ...
                    <li><strong>Klem de disk een de voorkant vast achter je schaambeen.</strong> Dit bot zit aan het begin van je vagina
                        bij je buik. Elk lichaam is anders, dus hoe ver dit precies zit ligt aan jouw bouw.
                    </li>
                    <li>Duw de disk zo ver dat hij niet meer verder naar achter kan. Nu kun je hem <strong>loslaten!</strong> Als de disk
                    ...
                    <li>Om de disk eruit te halen spreid je weer je benen en breng een schone vinger in je vagina. Haak
                        een vinger achter de rand van de disk, en <strong>haal de disk eruit</strong>. Zorg er wel voor dat
                    ...
                    <li>Begin weer bij stap 2, en blijf dit <strong>herhalen</strong> tot je menstruatie voorbij is. :)</li>
                    <li>Menstruatie voorbij? <strong>Kook je disk even uit</strong> en bewaar hem in de tussentijd in een ademend tasje op een droge locatie. (Dus liever niet in de
